...
### [59-2.队列的最大值](../src/main/java/_剑指Offer/_59_2_队列的最大值.java)

- 队列+双端队列

### [56-2.数组中数字出现的次数2](../src/main/java/_剑指Offer/_56_2_数组中数字出现的次数2.java)

- 位运算(按位统计，对3求余)★

### [51.数组中的逆序对](../src/main/java/_剑指Offer/_51数组中的逆序对.java)
